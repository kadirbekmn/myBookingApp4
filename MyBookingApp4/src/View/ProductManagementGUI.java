...
public class ProductManagementGUI extends JFrame {
    ...
    private JLabel lbl_productMgmt;
    ...
    public ProductManagementGUI(Manager manager) {
        ...
        lbl_productMgmt = new JLabel("Ürün Yönetimi");
        lbl_productMgmt.setFont(new Font("Yu Gothic UI Semibold", Font.PLAIN, 16));
        top_panel.add(lbl_productMgmt);
        
        lbl_welcome = new JLabel("Hoş Geldiniz null");
        lbl_welcome.setFont(new Font("Yu Gothic UI Semibold", Font.PLAIN, 16));
        top_panel.add(lbl_welcome, BorderLayout.EAST);
